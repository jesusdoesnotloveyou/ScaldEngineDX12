...
float4 main(PSInput input) : SV_TARGET
{
    ...
    float3 dirLight = CalcDirLight(gDirLight, gbuffer.normal.xyz, viewDir, mat, shadowFactor);
    ...
    litColor.rgb += ComputeSpecularReflections(toEye, gbuffer.normal.xyz, mat);
    
    // set the alpha channel of the diffuse material of the object itself
    litColor.a = gbuffer.diffuse.a;
